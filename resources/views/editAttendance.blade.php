	          ...
	          <div class="col-md-12">
	              <div class="panel panel-default">
	                  <div class="panel-heading">
	                      <h3 class="panel-title">Update Attendance  <a href="{{ route('allAttendance') }}" class="btn btn-sm btn-info pull-right">All Attendance</a></h3>
	                  </div>
	                                ...
	                                @csrf  	
	                                 ...
	                                 <input type="hidden" name="id[]" value="{{ $row->id }}">  
	                                         <td>
	                                         	...
	                                         	<input type="radio" name="attendance[{{ $row->id }}]" value="Absent" <?php if ($row->attendance == 'Absent') {
	                                         		echo "checked";
	                                         	} ?>>Absent
	                                         </td>
