              ...
              <div class="col-md-12">
                  <div class="panel panel-default">
                      <div class="panel-heading">
                          <h3 class="panel-title">Take Attendance  <a href="{{ route('allAttendance') }}" class="btn btn-sm btn-info pull-right">All Attendance</a></h3>
                      </div>
                          ...
                          <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                 <table {{-- id="datatable" --}} class="table table-striped table-bordered">
                                      ...
                                      <tbody>
                                  <form action="{{ url('/insertAttendance') }}" method="post">
                                    @csrf   
                                        @foreach($emp as $row)
                                          <tr>
                                              <td>{{ $row->name }}</td>
                                     ...
                                     <input type="hidden" name="emp_id[]" value="{{ $row->id }}">  
                                             <td>
                                                ...
                                                <input type="radio" name="attendance[{{ $row->id }}]" value="Absence">Absent
                                             </td>
