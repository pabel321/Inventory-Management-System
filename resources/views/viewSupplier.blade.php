                            ...
                            <div class="pull-right">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" role="menu" style="color: blue; ">
                                        ...
                                        <li> <strong>Shop Name: </strong> {{$single->shop}} </li>
                                        <li> <strong>Profession Type: </strong> {{$single->type}} </li>
                                        <li> <strong>Account Holder: </strong>{{$single->accountholder}} </li>
                                        <li> <strong>Account Number: </strong>{{$single->accountnumber}} </li>
                                        <li> <strong>Bank Name: </strong> {{$single->bankname}} </li>
                                        <li> <strong>Branch Name: </strong>{{$single->branchname}} </li>
